...
const COLUMNS = [
  ...
  {
    Header: () => <div className="ltr:ml-auto rtl:mr-auto">Duration</div>,
    accessor: 'questDuration',
    // @ts-ignore
    Cell: ({ cell: { value } }) => (<>
        <div className="ltr:text-right rtl:text-left">{value.startPeriod}</div>
        <div className="ltr:text-right rtl:text-left">{value.endPeriod}</div>
      </>
  ...
  {
    Header: () => <div className="ltr:ml-auto rtl:mr-auto">Actual Reward</div>,
    accessor: 'questReward',
    // @ts-ignore
    Cell: ({ cell: { value } }) => (<>
      <div className="ltr:text-center rtl:text-center">{value.stableReward} PUsdc</div>
      <div className="ltr:text-center rtl:text-center">{value.lessReward} Less</div>
    </>
  ...
  //   // @ts-ignore
  //   Cell: ({ cell: { value } }) => (<>
  //     <div className="ltr:text-center rtl:text-center">{value}</div>
  //     <div className="ltr:text-center rtl:text-center">{value}</div>
  //   </>
  ...
  //   maxWidth: 120,
  // },
  // (props.activeQuestData.waitingListAddress.includes(address)).toString()
  {
    Header: () => <div className="ltr:ml-auto rtl:mr-auto">Participants</div>,
  ...
  {
    Header: () => <div className="ltr:ml-auto rtl:mr-auto">More</div>,
    accessor: 'actionCall',
    // @ts-ignore
    Cell: ({ cell: { value } }) => (
      // <div className="ltr:text-right rtl:text-left">{value}</div>
      <QuestDetailsButton questId={value} />
    ),
    minWidth: 160,
    maxWidth: 220,
  },
...
export default function MainQuests_Table({
  activeQuestData
}: {
