...
export default function QuestDetailsFrame({ children }: React.PropsWithChildren<{}>) {
  ...
  return (
    <div className="pt-8 text-sm xl:pt-10">
      <div className="mx-auto w-full max-w-lg rounded-lg bg-white p-5 pt-4 shadow-card dark:bg-light-dark xs:p-6 xs:pt-5">
        <nav className="mb-5 min-h-[40px] border-b border-dashed border-gray-400 pb-4 uppercase tracking-wider dark:border-gray-500 xs:mb-6 xs:pb-5 xs:tracking-wide">
        ...
        {/* <AnimatePresence exitBeforeEnter> */}
          <motion.div
            ...
            animate="enter"
            exit="exit"
            variants={fadeInBottom('easeIn', 0.35)}
          >
            {children}
          </motion.div>
        {/* </AnimatePresence> */}
