export const mainQuests_data = [
  {
    id: 0,
    questName: 'Twitter Quest',
    questType: 'Social Media',
    createdAt: '12 august 2022',
    questEntryCost: '10 PUsdc',
    questActualPool: '10 Less',
    status: 'Need to Subscribe',
    questMoreButton: 'See More',
  },
  {
    id: 1,
    questName: '',
    ...
    createdAt: '',
    questEntryCost: '',
    questActualPool: 'More to Come !',
    status: 'Submit Your Ideas :',
    questMoreButton: 'Create Quest',
  },
  // {
  //   id: 2,
  //   transactionType: 'Buy',
