...
> = () => {
  return (
    <>
      ...
      {/* FIRST MOCKUP TRYYYY */}
      <div className="flex flex-col items-center justify-center h-full mt-20 gap-20 ">
      <div className="max-w-7xl rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:grid-cols-2 sm:gap-px">
